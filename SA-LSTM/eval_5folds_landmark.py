...
GT_DIR = f"/data1/xyh/data/nnUNet/nnUNet_raw/Dataset{TASK_ID}_CBCT_Landmark/labelsTr"

# 2. 你的 3d_fullres 主目录 (包含 fold_0, fold_1... 的那一层)
# BASE_MODEL_DIR = f"/data1/xyh/data/nnUNet/nnUNet_results/Dataset{TASK_ID}_CBCT_Landmark/nnUNetTrainer__nnUNetPlans__3d_fullres"

# 没有数据增强的版本
BASE_MODEL_DIR = f"/data1/xyh/data/nnUNet/nnUNet_results/Dataset{TASK_ID}_CBCT_Landmark/nnUNetTrainerNoMirroring__nnUNetPlans__3d_fullres"

# 3. dataset.json 的路径
DATASET_JSON_PATH = f"/data1/xyh/data/nnUNet/nnUNet_raw/Dataset{TASK_ID}_CBCT_Landmark/dataset.json"
