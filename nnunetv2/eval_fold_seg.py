...
# 2. Fold 0 验证集预测结果文件夹
PRED_DIR = "/data1/xyh/data/nnUNet/nnUNet_results/Dataset502_AirwaySegmentation/nnUNetTrainer__nnUNetPlans__3d_fullres/fold_4/validation"

# 3. 评估结果保存的 TXT 文件路径
OUTPUT_TXT_PATH = "/data1/xyh/data/nnUNet/nnUNet_results/Dataset502_AirwaySegmentation/nnUNetTrainer__nnUNetPlans__3d_fullres/fold_4/fold4_eval.txt"
# =========================================================
